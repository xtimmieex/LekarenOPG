...
**Timea** - LekarenUI, výpisy, predaj a naskladnenie, Tvorba sceny, Modelovanie hlavnej logiky programu do tried a metód
**Elizabeth** - Liek, UcinnaLatkaComparator, testovacie dáta, Štýlovanie pomocou CSS, Dokumentácia v markdowne, README.md, GitHub, Vzorové vstupné alebo testovacie dáta
**Dano** - SkladLiekov, vyraďovanie liekov, UML diagram, Vývojový diagram vybranej časti logiky programu, Ošetrenie vstupných hodnôt, krajné a špeciálne prípady
