...
**Timea** Tvorba sceny | Modelovanie hlavnej logiky programu do tried a metód

**Elizabeth** - Štýlovanie pomocou CSS | Dokumentácia v markdowne, README.md, GitHub | Vzorové vstupné alebo testovacie dáta

**Dano** - Vývojový diagram vybranej časti logiky programu | Ošetrenie vstupných hodnôt, krajné a špeciálne prípady
